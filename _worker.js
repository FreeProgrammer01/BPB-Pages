...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `MZ - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `MZ - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `MZ - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `MZ - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'MZ Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'MZ Frag - Best Ping 💥';
    ...
    bestFragment.remarks = 'MZ Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    warpEndpoints.split(',').forEach((endpoint, index) => {
        ...
        xrayWarpConfig.remarks = `MZ - Warp ${index + 1} 🇮🇷`;
    ...
    xrayWarpBestPing.remarks = 'MZ - Warp Best Ping 🚀';
